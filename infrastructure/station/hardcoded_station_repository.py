...
class HardcodedStationRepository(StationRepository):
    _STATIONS: list[Station] = [
        ...
        Station(id="guui",              name="구의",           line="2호선",        lat=37.5378, lng=127.0950),
        ...
        Station(id="seocho",            name="서초",           line="2호선",        lat=37.4836, lng=127.0122),
        ...
        Station(id="dongdae_ib",        name="동대입구",       line="3호선",        lat=37.5507, lng=126.9969),
        ...
        Station(id="jamwon",            name="잠원",           line="3호선",        lat=37.5124, lng=127.0051),
        ...
        Station(id="dogok",             name="도곡",           line="3·분당선",     lat=37.4893, lng=127.0458),
        Station(id="daechi",            name="대치",           line="3호선",        lat=37.4944, lng=127.0616),
        Station(id="hagnyeoul",         name="학여울",         line="3호선",        lat=37.4892, lng=127.0743),
        Station(id="daecheong",         name="대청",           line="3호선",        lat=37.4867, lng=127.0937),
        Station(id="irwon",             name="일원",           line="3호선",        lat=37.4902, lng=127.0847),
        ...
        Station(id="ogeum",             name="오금",           line="3·5호선",      lat=37.4979, lng=127.1331),
        ...
        Station(id="mia",               name="미아",           line="4호선",        lat=37.6200, lng=127.0340),
        ...
        Station(id="samgakji",          name="삼각지",         line="4·6호선",      lat=37.5337, lng=126.9641),
        Station(id="ichon",             name="이촌",           line="4호선",        lat=37.5187, lng=126.9671),
        Station(id="dongjak",           name="동작",           line="4·9호선",      lat=37.5087, lng=126.9796),
        ...
        Station(id="seodaemun",         name="서대문",         line="5호선",        lat=37.5722, lng=126.9675),
        ...
        Station(id="yeongdeungpo",      name="영등포시장",     line="5호선",        lat=37.5173, lng=126.8964),
        ...
        Station(id="gangdong",          name="강동",           line="5호선",        lat=37.5305, lng=127.1393),
        ...
        Station(id="hangangjin",        name="한강진",         line="6호선",        lat=37.5299, lng=126.9973),
        Station(id="noksapyeong",       name="녹사평",         line="6호선",        lat=37.5344, lng=126.9800),
        ...
        Station(id="wolgok",            name="월곡",           line="6호선",        lat=37.6030, lng=127.0523),
        ...
        Station(id="hakdong",           name="학동",           line="7호선",        lat=37.5192, lng=127.0351),
        Station(id="nonhyeon",          name="논현",           line="7호선",        lat=37.5119, lng=127.0244),
        Station(id="banpo",             name="반포",           line="7호선",        lat=37.5045, lng=126.9998),
        Station(id="naebang",           name="내방",           line="7호선",        lat=37.4952, lng=127.0114),
        Station(id="namseong",          name="남성",           line="7호선",        lat=37.4932, lng=126.9750),
        Station(id="sungsil_univ",      name="숭실대입구",     line="7호선",        lat=37.4961, lng=126.9598),
        Station(id="sangdo",            name="상도",           line="7호선",        lat=37.4950, lng=126.9489),
        Station(id="jangseungbaegi",    name="장승배기",       line="7호선",        lat=37.5003, lng=126.9337),
        Station(id="boramae",           name="보라매",         line="7호선",        lat=37.4939, lng=126.9211),
        ...
        Station(id="olympic_park",      name="올림픽공원",     line="9호선",        lat=37.5202, lng=127.1233),

        # ── 경의중앙선 (서울 구간) ──────────────────────────────────────────
        Station(id="dmc",               name="디지털미디어시티", line="6호선·경의중앙선", lat=37.5784, lng=126.8897),
